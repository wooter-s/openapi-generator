...
public class TypeScriptWooterClientCodegen extends AbstractTypeScriptClientCodegen {
    private static final Logger LOGGER = LoggerFactory.getLogger(TypeScriptWooterClientCodegen.class);
    ...
    public TypeScriptWooterClientCodegen() {
        super();

        modifyFeatureSet(features -> features.includeDocumentationFeatures(DocumentationFeature.Readme));

        this.outputFolder = "generated-code/typescript-wooter";

        supportsMultipleInheritance = true;

        embeddedTemplateDir = templateDir = "typescript-wooter";
    ...
    public String getName() {
        return "typescript-wooter";
    }

    @Override
    public String getHelp() {
        return "Generates a TypeScript Wooter (6.x - 10.x) client library.";
    }
