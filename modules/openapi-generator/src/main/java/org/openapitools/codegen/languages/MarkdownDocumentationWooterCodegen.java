...
public class MarkdownDocumentationWooterCodegen extends DefaultCodegen implements CodegenConfig {
    public static final String PROJECT_NAME = "projectName";

    private static final Logger LOGGER = LoggerFactory.getLogger(MarkdownDocumentationWooterCodegen.class);
    ...
    public MarkdownDocumentationWooterCodegen() {
        super();
...
//        apiTemplateFiles.put("api.mustache", ".md");
        embeddedTemplateDir = templateDir = "markdown-documentation-wooter";
